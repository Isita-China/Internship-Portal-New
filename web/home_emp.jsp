    ...
    <body>
        ...
        <%    
            ...
            try
            {
                ...
                String sql="select emp_name from Employer where emp_email='"+emp_mail+"'";
                rs=stm.executeQuery(sql);
                
                while(rs.next())
                {
                    out.print("<p class='msg'>Welcome,"+"<br>"+rs.getString("emp_name")+"</p>");
                }
        ...
        %>
                        ...
                        <div class="view_profile">
                            <input class="view_button" type="submit" name="view_button" value="View Profile" onclick="location.href='view_profile_emp.jsp'">
                        </div>
                    </div>
                </div>

    ...
    <body>
        ...
        <%
            ...
            try 
            {
                ...
                String sql = "select * from employer,employer_pd where employer.emp_email=employer_pd.com_email";
        ...
        %>
                        ...
                        <tr>
                            ...
                            <td><%=rs.getString("com_email")%></td>
                            <td><%=rs.getString("com_mob_no")%></td>
                            <td><%=rs.getString("com_address")%></td>
                        </tr>

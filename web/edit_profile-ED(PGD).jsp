        ...
        %>    
            ...
            <div class="display">
                ...
                <div class="right_pane">
                    <form class="educational_detail_form" name="post_graduation_form" onsubmit="return post_graduation_validation()" method="POST" action="post-graduation.jsp">

                        <div class="educational_detail">
                            <p class="text1">Educational Details</p>             
                            <p class="text2">Post-Graduation</p>

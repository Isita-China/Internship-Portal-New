    ...
    <body>
        ...
        <%
            ...
            try 
            {
                ...
                String sql = "select * from Student_ED_PGD where std_email ='" + stu_mail + "'";
        ...
        %>    
			...
			<ul>
                ...
                <div class="right_pane">
                    ...
                    <div class="next">
                        <input class="next_button" type="button" name="next_button" value="Next" onclick="location.href='view_profile-ID.jsp'">
                        <input class="back_button" type="button" name="back_button" value="Back" onclick="location.href='view_profile-ED(GD).jsp'">
                    </div>
                </div>

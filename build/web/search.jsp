...
<html>
    ...
    <body>
        ...
        %>
                    ...
                    <tr><td><a class="click" onclick="alert('You have to Login'); window.location = 'login.html';">View</a></td><td><a class="click" onclick="alert('You have to Login'); window.location = 'login.html';">Apply</a></td></tr>
                    </table>
        <%
                }

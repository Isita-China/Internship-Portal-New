    ...
    <body>
        ...
        <%
            ...
            try 
            {
                ...
                String sql = "select * from Student_PD where std_email ='" + get_st_id[0] + "'";
        ...
        %>         
                ...
                <div class="right_pane">
                    ...
                    <div class="next">
                        <input class="back_button" type="button" name="back_button" value="Back" onclick="location.href='view_applicants_list.jsp?inter=<%=hold_in_id%>'">
                    </div>
                </div>

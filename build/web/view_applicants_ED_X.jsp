    ...
    <body>
        ...
        <%
            ...
            try 
            {
                ...
                String sql = "select * from Student_ED_X where std_email ='" + get_st_id[0] + "'";
        ...
        %>         
                ...
                <div class="right_pane">
                    ...
                    <div class="next">
                        <input class="next_button" type="button" name="next_button" value="Next" onclick="location.href='view_applicants_ED_XII.jsp?st_id=<%=rs.getString("std_email")%>'">
